...
public class Task2 {
    public static void main(String[] args) {
        ...
        int num3 = ((5 + a++) / 8); // постинкремент b++ сначала вернет b, а потом увеличит b на 1 =>
        // 5 + 2 = 7 => 7 / 8 = 0;
        a = 2;

        int num4 = ((5 + a++) / --b); // постинкремент b++ сначала вернет b, а потом увеличит b на 1 =>
        // предекремент сначала уменьшит c на 1, а потом веренет c => 5 + 2 = 7 => 7 / 7 = 1;
        a = 2;
        b = 8;

        int num5 = ((5 * 2 >> a++) / --b); // постинкремент b++ сначала вернет b, а потом увеличит b на 1 =>
        // предекремент сначала уменьшит c на 1, а потом веренет c => 5 * 2 = 10 => 10 >> 2 = 2 => 2 / 7 = 0;
        a = 2;
        b = 8;

        int num6 = ((5 + 7 > 20 ? 68 : 22 * 2 >> a++) / --b);
        // постинкремент b++ сначала вернет b, а потом увеличит b на 1 =>
        // предекремент сначала уменьшит c на 1, а потом веренет c =>
        // 5 + 2 = 7 => 7 > e = false => 22 * 2 = 44 => 44 >> 2 = 11 => 11 / 7 = 1;
        a = 2;
        b = 8;
